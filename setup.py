...
setup( 
    ...
    url = 'https://github.com/Borghese-Gladiator/linkedin_scraper', # use the URL to the github repo 
    download_url = 'https://github.com/Borghese-Gladiator/linkedin_scraper/dist/' + version + '.tar.gz', 
